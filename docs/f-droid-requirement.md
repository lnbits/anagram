...
The app is viable for F-Droid, but the repository is not submission-ready yet. The published `v0.6.0` tag is the first Firebase-free F-Droid candidate and supersedes `v0.5.3`.
...
### 2. Firebase-free `v0.6.0` release
...
Do not submit `v0.5.3`. Use `v0.6.0` or a later clean release and continue increasing the Android version code for every future version.
...
6. Test the F-Droid build recipe in an fdroidserver environment.
